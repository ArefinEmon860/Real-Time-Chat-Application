...
const LoginPage = () => {
  ...
  return (
     <div style={{backgroundImage: `url(${bgImage})`,backgroundSize: 'cover',backgroundPosition: 'center',backgroundRepeat: 'no-repeat', }}
  className="w-full h-screen flex items-center justify-center sm:px-[15%] sm:py-[5%]"
>
